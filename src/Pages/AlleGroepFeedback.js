...
import AlleGroepFeedbackLijst from "../Components/AlleGroepFeedbackLijst";

export default function AlleGroepFeedback() {
    ...
    <div className={"container"}>
      <div className={"row"}>
        ...
        <div className={"col-4 gy-2"}>
          ...
          <AlleGroepFeedbackLijst onClick={handleClick} />
        </div>
        <div className={"col-1"}></div>
